...
| `compliance-licensing.md` | File-pattern and task based: adding/upgrading/removing a dependency, third-party service, or AI model/provider, or editing `LICENSE`/`THIRD_PARTY_LICENSES.md` | Read `docs/standards/compliance-licensing-standard.md`; escalate copyleft, non-commercial, custom-licensed, or unlicensed dependencies to the repository owner before adoption. |
...
| `telemetry.md` | File-pattern and task based: structured events, logs, metrics, traces, correlation IDs, audit/security events, analytics, telemetry retention, AI telemetry | Read `docs/standards/telemetry-standard.md`; apply related runtime observability, security, data, quality, and release standards when their scopes match. |

...
| 08 | [Agent Engineering (LangGraph)](08-agent-engineering.md) | Valentina Cruz, Customer Experience Manager | 🚧 Phases 0–4 implemented; Phase 4 awaiting owner review, Phase 5 pending, Phase 3 Codespaces exercise unverified | `services/central-api/`, `services/identity/`, `packages/trackflow_auth/`, `mcps/`, `uis/backoffice/`, `docs/agents/` |

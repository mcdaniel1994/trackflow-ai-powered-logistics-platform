...
| 08 | [Agent Engineering (LangGraph)](08-agent-engineering.md) | Valentina Cruz, Customer Experience Manager | 🚧 Phases 0–2 committed; Phase 3 implemented, pending owner review | `services/central-api/`, `services/identity/`, `packages/trackflow_auth/`, `mcps/`, `uis/backoffice/`, `docs/agents/` |

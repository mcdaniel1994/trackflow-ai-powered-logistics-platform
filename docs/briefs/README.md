...
| 08 | [Agent Engineering (LangGraph)](08-agent-engineering.md) | Valentina Cruz, Customer Experience Manager | 🚧 Phases 0–6 implemented; local tunneled MCP/Inspector evidence recorded, Phases 4–6 awaiting owner review, Phase 3 Codespaces exercise unverified | `services/central-api/`, `services/identity/`, `packages/trackflow_auth/`, `mcps/`, `uis/backoffice/`, `docs/agents/` |

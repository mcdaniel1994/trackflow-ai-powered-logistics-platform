...
| 06 | [Data Pipelines & Telemetry](06-data-pipelines-telemetry.md) | Andrés Kim, CTO | 🚧 In progress | `services/central-api/` (telemetry domain), `services/identity/`, `uis/backoffice/` |

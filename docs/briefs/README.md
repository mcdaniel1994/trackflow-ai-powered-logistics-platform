...
| 10 | [Real-Time Systems — Push Notifications and Streaming Chat](10-realtime-systems.md) | Miguel Torres, Commercial Director; Valentina Cruz, Customer Experience | 🚧 Owner-approved; Phase 0 verified and Part 1 (Phases 1–2) implemented, awaiting owner review | `services/central-api/`, `uis/backoffice/`, `compose.coolify.yaml` |

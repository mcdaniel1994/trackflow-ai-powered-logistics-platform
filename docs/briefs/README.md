...
| 09 | [Agentic Workflows — Automated RFP Desk](09-agentic-workflows.md) | Miguel Torres, Commercial Director | 🚧 In progress on branch `engagement-9-agentic-workflows`; spec approved, Phase 0 scaffolding underway (Phases 1–3 to follow) | `services/central-api/`, `uis/backoffice/`, `data/raw/` |

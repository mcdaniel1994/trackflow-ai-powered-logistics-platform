...
| 09 | [Agentic Workflows — Automated RFP Desk](09-agentic-workflows.md) | Miguel Torres, Commercial Director | 🚧 In progress on branch `engagement-9-agentic-workflows`; spec approved, Phases 0–2 implemented (scaffolding; intake & routing; generation & evaluation), Phase 3 to follow | `services/central-api/`, `uis/backoffice/`, `data/raw/` |

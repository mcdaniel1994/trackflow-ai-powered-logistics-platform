...
| 06 | [Data Pipelines & Telemetry](06-data-pipelines-telemetry.md) | Andrés Kim, CTO | 🚧 6.1 closed by owner exception; 6.2 production-accepted; 6.3 owner-accepted by exception; 6.4 time gates waived, direct-SQL swap deployed, and Prefect retired August 2026 ([retirement note](../archive/prefect-orchestration-retirement.md)), deployment verification pending; independent 6.5.a–b complete offline | `data/`, `services/central-api/`, `services/identity/`, `uis/backoffice/`, `.github/workflows/` |
...
| 10 | [Real-Time Systems — Push Notifications and Streaming Chat](10-realtime-systems.md) | Miguel Torres, Commercial Director; Valentina Cruz, Customer Experience | ✅ Implementation complete — PRs #35 and #36 merged to `main` on 2026-08-18; Phase 6 production rollout deferred, production unchanged | `services/central-api/central_api/domains/{realtime,chat}/`, `data/pipelines/rag.py`, `uis/backoffice/`, `compose.coolify.yaml` |

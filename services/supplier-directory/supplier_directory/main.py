...
from .config import get_cors_origins, get_db_path
...
def create_app() -> FastAPI:
    ...
    async def create_supplier(payload: SupplierCreate) -> SupplierPublic:
    ...
    async def get_supplier(supplier_id: str) -> SupplierPublic:
        return supplier_or_404(supplier_id)

    @app.get("/suppliers/{supplier_id}/contact", response_model=SupplierContact)
    async def get_supplier_contact(supplier_id: str) -> SupplierContact:
    ...
    async def update_supplier_rate(supplier_id: str, payload: RateUpdate) -> SupplierPublic:
    ...
    async def update_supplier_status(supplier_id: str, payload: StatusUpdate) -> SupplierPublic:
    ...
    async def delete_supplier(supplier_id: str) -> Response:

...
import { errorMessage, patchCandidate } from "@/lib/talent/api";
import { stageLabel, stageOptions, statusLabel, statusOptions } from "@/lib/talent/labels";
import type { Candidate, CandidatePatch, Note, Stage, Status } from "@/lib/talent/types";
import { CandidateForm } from "@/components/talent/CandidateForm";
import { NotesPanel } from "@/components/talent/NotesPanel";
  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <Link href="/talent/new" className={buttonClassName("secondary")}>
          Register candidate
        </Link>
      </header>
